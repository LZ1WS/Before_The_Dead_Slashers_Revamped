...
GM.MAP.Vaccine = {
	Box = {
		 {type="sls_vaccine", pos=Vector(-474.042358, 1962.614990, 0.031250), ang=Angle(0, -90, 0),},
		 {type="sls_vaccine", pos=Vector(-118.912560, -1000.073303, 247.145111), ang=Angle(0, 90, 0),},
		 {type="sls_vaccine", pos=Vector(-46.903492, 40.359501, -319.968750), ang=Angle(-90, 90, 0),},
		 {type="sls_vaccine", pos=Vector(915.421997, -775.584045, -381.709534), ang=Angle(0, -180, 0),},
		 {type="sls_vaccine", pos=Vector(-2214.183838, 401.859558, -223.968750), ang=Angle(0, -90, 0),},
