...
LANG["class_desc_huntress"] = "You can throw axes with your second weapon."
...
LANG["class_desc_cloaker"] = "I CALL THIS A DIFFICULTY TWEAK!\nWhen you press the Q, you speedup and begin to see through the walls  closest (5m) survivors to you (if any)."
