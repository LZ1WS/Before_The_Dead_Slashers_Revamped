if CLIENT then
SWEP.WepSelectIcon = surface.GetTextureID( "pwb/sprites/xm1014" )
SWEP.DrawWeaponInfoBox	= false
SWEP.BounceWeaponIcon = false
killicon.Add( "weapon_pwb_xm1014", "pwb/sprites/xm1014", Color( 255, 255, 255, 255 ) )
end
...
SWEP.ViewModel = "models/pwb/weapons/v_xm1014.mdl"
...
SWEP.Primary.Sound = Sound( "Weapon_PWB_XM1014.Shoot" )
...
self.Owner:ViewPunch( Angle( 0.025, -0.05, 0 ) )
end
end
