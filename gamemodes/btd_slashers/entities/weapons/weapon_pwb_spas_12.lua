...
killicon.Add( "weapon_pwb_spas_12", "pwb/sprites/spas_12", Color( 255, 255, 255, 255 ) )
end
...
SWEP.ViewModel = "models/pwb/weapons/v_spas_12.mdl"
...
SWEP.Primary.Sound = Sound( "Weapon_PWB_SPAS_12.Shoot" )
