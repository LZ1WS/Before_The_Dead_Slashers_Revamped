...
if CLIENT then
	hook.Add( "HUDPaint", "slashers_trap_hud", function()
		if !LocalPlayer():Alive() || !IsValid(LocalPlayer():GetActiveWeapon()) then return end
		local w = LocalPlayer():GetActiveWeapon():GetClass()
		if w ~= "weapon_beartrap" and w ~= "weapon_survivor_beartrap" and w ~= "weapon_alertropes" and w ~= "weapon_dooraxe" then return end
