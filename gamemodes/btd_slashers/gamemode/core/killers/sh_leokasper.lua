...
-- Killer
KILLER.Name = "Leo Kasper"
KILLER.Model = "models/svotnik/Leo_Kasper/Leo_Kasper_PM.mdl"
KILLER.WalkSpeed = 190
KILLER.RunSpeed = 210
KILLER.UniqueWeapon = false
KILLER.ExtraWeapons = {}
KILLER.StartMusic = "sound/kasper/voice/intro.mp3"
KILLER.ChaseMusic = "kasper/chase/chase.ogg"
KILLER.TerrorMusic = "kasper/terror/terror.wav"

if CLIENT then
	KILLER.Desc = GM.LANG:GetString("class_desc_kasper")
	KILLER.Icon = Material("icons/kasper.png")
end
